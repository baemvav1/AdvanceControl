        ...
        public App()
        {
            ...
            Host = Microsoft.Extensions.Hosting.Host.CreateDefaultBuilder()
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    services.AddHttpClient<Services.RelacionOperacionProveedorRefaccion.IRelacionOperacionProveedorRefaccionService, Services.RelacionOperacionProveedorRefaccion.RelacionOperacionProveedorRefaccionService>((sp, client) =>
                    {
                        var provider = sp.GetRequiredService<IApiEndpointProvider>();
                        if (Uri.TryCreate(provider.GetApiBaseUrl(), UriKind.Absolute, out var baseUri))
                        {
