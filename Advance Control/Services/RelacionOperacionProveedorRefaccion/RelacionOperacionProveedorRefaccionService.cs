...
namespace Advance_Control.Services.RelacionOperacionProveedorRefaccion
{
    ...
    public class RelacionOperacionProveedorRefaccionService : IRelacionOperacionProveedorRefaccionService
    {
        ...
        /// </summary>
        public async Task<bool> CreateRelacionAsync(int idOperacion, int idProveedorRefaccion, float precio, string? nota, CancellationToken cancellationToken = default)
        {
            try
            {
                if (idOperacion <= 0)
