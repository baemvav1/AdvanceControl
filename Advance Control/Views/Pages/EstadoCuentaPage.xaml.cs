...
namespace Advance_Control.Views.Pages
{
    ...
    /// </summary>
    public sealed partial class EstadoCuentaPage : Page
    {
        private static readonly List<Window> VentanasDetalleAbiertas = new();
        public EsCuentaViewModel ViewModel { get; }
        private readonly IActivityService _activityService;

        public EstadoCuentaPage()
        {
            InitializeComponent();
            ButtonClickLogger.Attach(this, AppServices.Get<ILoggingService>(), nameof(EstadoCuentaPage));
