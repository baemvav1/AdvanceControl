...
namespace Advance_Control.Services.RelacionOperacionProveedorRefaccion
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Obtiene una lista de relaciones operación-proveedor-refacción para un ID de operación
        /// </summary>
        /// <param name="idOperacion">ID de la operación</param>
        /// <param name="cancellationToken">Token de cancelación</param>
        /// <returns>Lista de relaciones operación-proveedor-refacción</returns>
        ...
        /// </summary>
        /// <param name="idOperacion">ID de la operación</param>
        /// <param name="idProveedorRefaccion">ID de la proveedor-refacción</param>
        ...
        Task<bool> CreateRelacionAsync(int idOperacion, int idProveedorRefaccion, float precio, string? nota, CancellationToken cancellationToken = default);
    }
}
