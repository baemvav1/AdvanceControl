...
namespace Advance_Control.Views
{
    ...
    /// </summary>
    public sealed partial class AcesoriaView : Page
    {
        ...
        public AcesoriaView()
        {
            ...
            ButtonClickLogger.Attach(this, ((App)Application.Current).Host.Services.GetRequiredService<ILoggingService>(), nameof(AcesoriaView));
